...
function [c_t,t] = get_single_dose_curve_min_dose(c0,dose,tHalf,tInt,F,vd,~,ka,min_dose)
...
% we want the bpl curve to reflect a fraction of the minimum effective
% dose, so divide dose curve by curve generated by the minimum effective
% dose for new normalized levels...

...
my_path = Path("/gdrive/public/USERS/nghosn3/Pioneer/DATA")
...
path_base = "/gdrive/public/USERS/pattnaik/hmm-emu-state-space/data"
...
for i in range(0,len(pt_ids)):    # load signal
    ...
    filename = r'/gdrive/public/USERS/nghosn3/Pioneer/spikes-AED/results/change_point/' + pt_ids[i] + "_BPbkpts" '.mat'
